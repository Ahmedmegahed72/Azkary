...
import com.example.azkary.Adapter.SurahAdapter;
import com.example.azkary.activities.SurahDetailActivity;
import com.example.azkary.common.Common;
import com.example.azkary.listener.SurahListener;
import com.example.azkary.model.Surah;
import com.example.azkary.viewmodel.SurahViewModel;
...
public class Quran extends AppCompatActivity implements SurahListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        surahViewModel.getSurah().observe(this, surahResponse ->{
            ...
            if(list.size()!=0)
            {
                surahAdapter=new SurahAdapter(this,list, (SurahListener) this);
